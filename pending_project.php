...
<div class="container-xl px-4 mt-4">
    <nav aria-label="breadcrumb" class="main-breadcrumb" style="width:100% ;">
            <ol class="breadcrumb"  style="background-color:white;">
              ...
              <li class="breadcrumb-item active" aria-current="page">Peding Projects</li>
            </ol>
    </nav>
    <!DOCTYPE html>
<html>
...
<table id="customers">
  ...
  <?php
    include('config.php');
    $sql = "SELECT t.project_title, t.project_date, t.id_professional, t.project_status, u.username FROM tbl_projects AS t INNER JOIN user_account AS u ON t.id_professional = u.id WHERE t.project_status = 'Pending' AND t.id_user = '$Id'";
