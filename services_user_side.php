...
<div class="search-container" style="float:right; margin-top:1px; margin-bottom:8px;" >
    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
      <input class="search" type="text" placeholder=" Search by category.." name="search">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT * FROM gig_post WHERE category LIKE '%$name%' OR content LIKE '%$name%' OR prim = '$primary' ORDER BY date DESC";
        ...
        <div class="ibox">
            <div class="ibox-content product-box" style="margin-top:1px; height:400px;">
                ...
                <span class="product-price">
                    ...
                    <br>
                   <a href="avail_user_side.php?id=<?php echo $record['id'];?>" class="btn btn-success" style="border:none; width:100%; margin-top:-10%;"><span class="glyphicon glyphicon-cog"></span> Avail Service</a>
