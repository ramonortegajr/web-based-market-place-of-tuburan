...
<div class="container">
         ...
         <nav aria-label="breadcrumb" class="main-breadcrumb" style="width:100% ;">
            <ol class="breadcrumb"  style="background-color:white;">
              <li class="breadcrumb-item"><a href="index_feeds.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page" style="text-decoration:underline;"><a href="user_landing.php">Professional List</a></li>
              ...
              <li style="float:right;" class="breadcrumb-item" aria-current="page"><a href="dashboard_user.php">Dashboard</a></li>
            </ol>
    </nav>
    <!-- End Breadcrumb -->
<!---SEARCH----->
<div class="search-container" style="float:right; margin-top:1px; margin-bottom:8px;" >
    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
      <input class="search" type="text" placeholder=" Search by service/skills.." name="search">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  //query code to pullout info
    $sql = "SELECT * FROM user_account WHERE firstname = '$name' OR username = '$name' OR isVerified = '$isVerified' OR skills LIKE '%$name%' OR position LIKE '%$name%' ORDER BY hiredtimes DESC";
        ...
        <div class="ibox">
            <div class="ibox-content product-box" style="margin-top:1px; height:450px;">
                ...
                <div class="product-desc">
                    ...
                    <a href="#" style="float:left;"><b><small class="text-muted">Skills/Service: <?php echo substr_replace($record['skills'], "..",10)?></small></b></a>
                    <br>
                    <br>
                    <br>
                    <div class="btn-tool" style="float:left; width:30%; margin-left:-25%;">
                    <a href="hire_user_side.php?id=<?php echo $record['id'];?>" class="btn btn-primary" style="margin-left:60%; margin-top:-28%; width:190%;"><span class="glyphicon glyphicon-briefcase"></span>    Hire Now</a> 
                    </div>
                    <div class="btn-tool" style="float:right; width:30%; margin-right:33%;">
                    <a href="profile_user.php?id=<?php echo $record['id'];?>" class="btn btn-primary" style="margin-left:60%; margin-top:-28%; width:190%;"><span class="glyphicon glyphicon-user"></span>    Profile</a> 
                    </div>
                    </div>
