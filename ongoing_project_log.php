...
<table id="customers">
  ...
  <?php
    include('config.php');
    $sql = "SELECT t.project_title, t.project_date, t.id_professional, t.project_status, u.username FROM tbl_projects AS t INNER JOIN user_account AS u ON t.id_professional = u.id WHERE t.project_status = 'Ongoing' AND t.id_user = '$Id'";
