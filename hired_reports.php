...
$con  = mysqli_connect("localhost","root","","ompls");
 if (!$con) {
    echo "Problem in database connection! Contact administrator!";
         ...
         $sql ="SELECT COUNT(project_date) AS total, project_date FROM tbl_projects WHERE id_professional = '$Id' GROUP BY project_date";
...
<html lang="en"> 
    ...
    <body style="background-color:lightgrey;">
         ...
         <nav aria-label="breadcrumb" class="main-breadcrumb" style="width:90%;margin-left:5%;">
          ...
          <!-- /Breadcrumb -->
          <h2 class="page-header" style="text-align:center;color:white;color:black;">Graphical Reports of Top Date Mostly Hired</h2>
        ...
        <p style="text-align:center;color:darkgrey;">This data is based on the information pull out from database to check the reports of professionals mostly hired on that day.</p>
