...
<h3 style="margin-left:17px;">Professionals Gig</h3>
			                 ...
			                 ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label label-default"><?php echo $record['date'];?></span>
                                    </td>
                                    <td>
                                        <a href="#"><?php echo $record['isavail'];?></a>
                                    </td>
                                    <td>
                                        <a href="#"><?php echo $record['posted_by'];?></a>
                                    </td>
                                    <td style="width:20%;">
                                        
                                        <a href="delete_gig.php?id=<?php echo $record['id']; ?>" class="table-link danger">
                                            <span class="fa-stack">
