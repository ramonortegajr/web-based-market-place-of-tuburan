...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Dashboard-Freelancer| Online Market Place for Local Skills </title>
  ...
  <section class="home-section">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <h3 style="margin-left:10px;">Pending Projects</h3>
                <hr>
                ...
                <div class="card-body">
                    <div class="table-responsive project-list">
                        <table class="table project-table table-centered table-nowrap">
                            ...
                            <?php
                                include('config.php');
                                $sql = "SELECT t.id, t.project_title, t.project_fullname, t.project_address, t.project_contact, t.project_date, t.project_status, u.username FROM tbl_projects AS t INNER JOIN user_account AS u ON t.id_professional = u.id  WHERE t.id_professional = '$Id' AND t.project_status = 'Pending'";
                                $resultset = mysqli_query($conn, $sql) or die("database error:". mysqli_error($conn));			
                                while( $record = mysqli_fetch_assoc($resultset) ) {
                               // $imageURL = 'upload/'.$record["image"];
                             ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $record['project_fullname'];?></td>
                                    <td><?php echo $record['project_address'];?></td>
                                    <td><?php echo $record['project_contact'];?></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="action">
                                            <a href="accept_project.php?id=<?php echo $record['id'];?>" class="text-success mr-4" data-toggle="tooltip" data-placement="top" title=""> <i class="fa fa-check h5 m-0"></i> Accept</a> |
                                            <a href="decline.php?id=<?php echo $record['id'];?>" class="text-success mr-4" data-toggle="tooltip" data-placement="top" title=""> <i class="fa fa-close h5 m-0" style="color:red;"></i> Decline</a>
                                        </div>
                                    </td>
...
<div class="container bootstrap snippets bootdey">
    <div class="row">
        <div class="col-lg-12">
            <div class="main-box no-header clearfix">
                <h3 style="margin-left:10px;">Ongoing Projects</h3>
                <hr>
                <div class="main-box-body clearfix">
                <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="table-responsive project-list">
                        <table class="table project-table table-centered table-nowrap">
                            ...
                            <tr>
                                <?php
                                include('config.php');
                                $sql = "SELECT t.id, t.project_title, t.project_fullname, t.project_address, t.project_contact, t.project_date, t.project_status, u.username FROM tbl_projects AS t INNER JOIN user_account AS u ON t.id_professional = u.id  WHERE t.id_professional = '$Id' AND t.project_status = 'Ongoing'";
                                $resultset = mysqli_query($conn, $sql) or die("database error:". mysqli_error($conn));			
                                while( $record = mysqli_fetch_assoc($resultset) ) {
                               // $imageURL = 'upload/'.$record["image"];
                             ?>
                            <tbody>
                                    ...
                                    <td>
                                        <div class="action">
                                            <a href="completed.php?id=<?php echo $record['id'];?>" class="text-success mr-4" data-toggle="tooltip" data-placement="top" title=""> <i class="fa fa-check h5 m-0"></i> Complete</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
...
<div class="container bootstrap snippets bootdey">
    <div class="row">
        <div class="col-lg-12">
            <div class="main-box no-header clearfix">
                <h3 style="margin-left:10px;">Completed Projects</h3>
                <hr>
                <div class="main-box-body clearfix">
                <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="table-responsive project-list">
                        <table class="table project-table table-centered table-nowrap">
                            ...
                            <?php
                                include('config.php');
                                $sql = "SELECT t.id, t.project_title, t.project_fullname, t.project_address, t.project_contact, t.project_date, t.project_status, u.username FROM tbl_projects AS t INNER JOIN user_account AS u ON t.id_professional = u.id  WHERE t.id_professional = '$Id' AND t.project_status = 'Completed'";
                                $resultset = mysqli_query($conn, $sql) or die("database error:". mysqli_error($conn));			
                                while( $record = mysqli_fetch_assoc($resultset) ) {
                               // $imageURL = 'upload/'.$record["image"];
                             ?>
