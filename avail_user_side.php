...
<?php
  ...
  if(isset($_GET['id'])) {
    $id_prof = $_GET['id'];
    $query = "SELECT * FROM gig_post WHERE id = $id_prof";
    // FETCHING DATA FROM DATABASE
    $result = mysqli_query($conn, $query);
    $row = mysqli_fetch_assoc($result);
    $imageURL = 'gigs/'.$row["image"];
  }
   $conn->close();
  ?>
...
<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $id_p = $id_prof;
    $query = "UPDATE gig_post SET isavail = isavail + 1 WHERE id = '$id_p'";
...
<div class="container-xl px-4 mt-4">
    <nav aria-label="breadcrumb" class="main-breadcrumb" style="width:100% ;">
            <ol class="breadcrumb"  style="background-color:white;">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="user_landing.php">Hire</a></li>
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <hr>
                    <div class="small font-italic text-muted mb-4"><p>Avail Times: <?php echo $row['isavail'];?></p>
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="project" value="<?php echo $row['category'];?>"> 
                        </div>

                        <input name="id_prof" value="<?php echo $row['id_post'];?>" type="hidden">
